...
extension MockGivenIntegrationTests {
    ...
    static let __allTests__MockGivenIntegrationTests = [
        ...
        ("test_Readable_get_shouldReturnFromWillReturn", test_Readable_get_shouldReturnFromWillReturn),
        ("test_Writable_get_shouldReturnFromWillReturn", test_Writable_get_shouldReturnFromWillReturn),
        ("test_Writable_set_shouldNotReturnFromWillCompletion", test_Writable_set_shouldNotReturnFromWillCompletion),
        ("test_Writable_set_shouldReturnFromWillCompletion", test_Writable_set_shouldReturnFromWillCompletion),
    ]
}
