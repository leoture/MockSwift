...
extension MockIntegrationTests {
    ...
    static let __allTests__MockIntegrationTests = [
        ("test_computed_get_shouldReturnFromMockInit", test_computed_get_shouldReturnFromMockInit),
        ("test_function_shouldReturnValueFromMockInit", test_function_shouldReturnValueFromMockInit),
    ]
}
